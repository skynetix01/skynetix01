...
export const servicesData = {
  ...
  `,
  note: "Note: We do not provide WordPress-based SEO. Our SEO services are primarily offered along with custom website development to ensure best performance and results.",
  examples: [
 ...
 'seo-services': {
  ...
  `,
  note: "Note: We do not offer standalone WordPress SEO services. Our SEO is mainly provided along with website development or custom-built platforms for optimal results.",
  examples: [
...
<section className={styles.pricingSection}>
  <div className={styles.pricingContainer}>
    ...
    <div className={styles.pricingRow}>
      {service.pricing.split('•').map((item, index) => {
